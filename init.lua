...
vim.opt.splitbelow = true -- split vertical window to the bottom

-- dash is part of the word
...
vim.keymap.set("n", "<leader>sx", "<cmd>close<CR>", { desc = "Close current splits" })
...
-- navigation
vim.keymap.set("n", "<C-d>", "<C-d>zz", { desc = "View below and center the pointer" })
vim.keymap.set("n", "<C-u>", "<C-u>zz", { desc = "View above and center the pointer" })
